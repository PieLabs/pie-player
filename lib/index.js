...
export default class PiePlayer extends HTMLElement {
  ...
  constructor() {
    ...
    this.style.setProperty('--default-color', 'black');
    this.style.setProperty('--default-background-color', 'white');
    this.style.color = 'var(--default-color)';
    this.style.backgroundColor = 'var(--default-background-color)';
  ...
  _updateColorContrast(colorContrast){
    ...
    if (colorContrast) {
      this.style.setProperty('--default-color', this.colorSchemes[colorContrast].color);
      this.style.setProperty('--default-background-color', this.colorSchemes[colorContrast].backgroundColor);
    }
  }
  _update() {
